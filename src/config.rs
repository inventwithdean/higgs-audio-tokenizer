...
use crate::{dac::config::DacConfig, hubert::config::HubertConfig};

#[derive(Serialize, Deserialize)]
pub struct HiggsAudioV2TokenizerConfig {
...
pub fn get_config() -> HiggsAudioV2TokenizerConfig {
    serde_json::from_value::<HiggsAudioV2TokenizerConfig>(json!(
    {
